...
import pl.zzpj.esportbetting.exception.ApplicationException;
...
import pl.zzpj.esportbetting.exception.UnauthorizedActionException;
    ...
    private static class ExceptionTransformer {
        ...
        ResponseEntity<GeneralError> to(HttpStatus httpStatus) {
            return ResponseEntity.status(httpStatus).body(
                    new GeneralError().builder().code(code).message(message).build());
        }
