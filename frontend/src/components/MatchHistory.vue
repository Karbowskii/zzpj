                ...
                <b-row>
                    <b-col cols="2" class="bet-result">
                        <a v-if="bet.selectedA">
                            <a v-if="bet.match.whichTeamWon===1" class="win">+{{bet.coins * bet.match.stakeA - bet.coins}}</a>
                    ...
                    <b-col cols="2" class="bet-result">
                        <a v-if="!bet.selectedA">
                            <a v-if="bet.match.whichTeamWon===2" class="win">+{{bet.coins * bet.match.stakeB - bet.coins}}</a>
